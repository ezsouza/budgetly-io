...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "dashboard.editTransactions": "Edit Transactions",
    "monthNavigation.previous": "Previous",
    "monthNavigation.next": "Next",
    "monthNavigation.backToMonth": "Back to Month",
    ...
    "editTransaction.headerTitle": "Edit Transaction",
    "editTransaction.headerSubtitle": "Update your financial record",
    "editTransaction.save": "Save Changes",
    "editTransaction.delete": "Delete Transaction",
    ...
    "overviewCalendar.title": "Annual Overview",
    "overviewCalendar.annualStats": "Annual Stats",
    "overviewCalendar.netIncome": "Net Income",
    "overviewCalendar.viewTransactions": "Transactions",
    "overviewCalendar.viewDaily": "Daily Net",
    "overviewCalendar.viewAnnual": "Annual Net",
    "dashboard.annualOverview": "Annual Overview",
    "login.email": "Email",
  ...
  pt: {
    ...
    "dashboard.editTransactions": "Editar Transações",
    "monthNavigation.previous": "Anterior",
    "monthNavigation.next": "Próximo",
    "monthNavigation.backToMonth": "Voltar ao Mês",
    ...
    "addTransaction.noEndDate": "Sem Data de Término",
    ...
    "editTransaction.headerTitle": "Editar Transação",
    "editTransaction.headerSubtitle": "Atualize o registro financeiro",
    "editTransaction.save": "Salvar Alterações",
    "editTransaction.delete": "Excluir Transação",
    ...
    "overviewCalendar.title": "Visão Anual",
    "overviewCalendar.annualStats": "Estatísticas Anuais",
    "overviewCalendar.netIncome": "Saldo",
    "overviewCalendar.viewTransactions": "Transações",
    "overviewCalendar.viewDaily": "Saldo Diário",
    "overviewCalendar.viewAnnual": "Saldo Anual",
    "dashboard.annualOverview": "Visão Anual",
    "login.email": "Email",
  ...
  es: {
    ...
    "dashboard.editTransactions": "Editar Transacciones",
    "monthNavigation.previous": "Anterior",
    "monthNavigation.next": "Siguiente",
    "monthNavigation.backToMonth": "Volver al Mes",
    ...
    "addTransaction.currency": "Moneda",
    ...
    "addTransaction.noEndDate": "Sin Fecha Final",
    ...
    "editTransaction.headerTitle": "Editar Transacción",
    "editTransaction.headerSubtitle": "Actualiza tu registro financiero",
    "editTransaction.save": "Guardar Cambios",
    "editTransaction.delete": "Eliminar Transacción",
    ...
    "overviewCalendar.title": "Visión Anual",
    "overviewCalendar.annualStats": "Estadísticas Anuales",
    "overviewCalendar.netIncome": "Saldo",
    "overviewCalendar.viewTransactions": "Transacciones",
    "overviewCalendar.viewDaily": "Saldo Diario",
    "overviewCalendar.viewAnnual": "Saldo Anual",
    "dashboard.annualOverview": "Visión Anual",
    "login.email": "Correo",
