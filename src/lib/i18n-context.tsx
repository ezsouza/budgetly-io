...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "addTransaction.creditCard": "Credit Card",
    "addTransaction.selectCard": "Select a card",
    "addTransaction.newCard": "Add New Card",
    "addTransaction.noCard": "None",
    "addTransaction.limitExceeded": "This will exceed the card limit. Click OK to adjust the limit or Cancel to abort.",
    "addCard.title": "New Credit Card",
    "addCard.name": "Card Name",
    "addCard.brand": "Brand",
    "addCard.closing": "Closing Day",
    "addCard.due": "Due Day",
    "addCard.limit": "Limit",
    "addCard.save": "Save Card",
    "wallet.title": "Wallet",
    "wallet.cards": "Credit Cards",
    "wallet.limit": "Limit",
    "wallet.closing": "Closing",
    "wallet.due": "Due",
  ...
  pt: {
    ...
    "navbar.hello": "Olá,",
    "navbar.timeline": "Linha do Tempo",
    "navbar.wallet": "Carteira",
    ...
    "addTransaction.creditCard": "Cartão de Crédito",
    "addTransaction.selectCard": "Selecione um cartão",
    "addTransaction.newCard": "Adicionar Novo Cartão",
    "addTransaction.noCard": "Nenhum",
    "addTransaction.limitExceeded": "Isso excederá o limite do cartão. Clique em OK para ajustar ou Cancelar para abortar.",
    "addCard.title": "Novo Cartão de Crédito",
    "addCard.name": "Nome do Cartão",
    "addCard.brand": "Bandeira",
    "addCard.closing": "Fechamento",
    "addCard.due": "Vencimento",
    "addCard.limit": "Limite",
    "addCard.save": "Salvar Cartão",
    "wallet.title": "Carteira",
    "wallet.cards": "Cartões",
    "wallet.limit": "Limite",
    "wallet.closing": "Fechamento",
    "wallet.due": "Vencimento",
  ...
  es: {
    ...
    "navbar.hello": "Hola,",
    "navbar.timeline": "Cronología",
    "navbar.wallet": "Billetera",
    ...
    "addTransaction.creditCard": "Tarjeta de Crédito",
    "addTransaction.selectCard": "Selecciona una tarjeta",
    "addTransaction.newCard": "Agregar Nueva Tarjeta",
    "addTransaction.noCard": "Ninguna",
    "addTransaction.limitExceeded": "Esto excederá el límite de la tarjeta. Pulsa OK para ajustar o Cancelar para abortar.",
    "addCard.title": "Nueva Tarjeta de Crédito",
    "addCard.name": "Nombre de la Tarjeta",
    "addCard.brand": "Marca",
    "addCard.closing": "Cierre",
    "addCard.due": "Vencimiento",
    "addCard.limit": "Límite",
    "addCard.save": "Guardar Tarjeta",
    "wallet.title": "Billetera",
    "wallet.cards": "Tarjetas",
    "wallet.limit": "Límite",
    "wallet.closing": "Cierre",
    "wallet.due": "Vencimiento",
